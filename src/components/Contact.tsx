        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <div className="space-y-6">
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-gray-600">hello@ppmai.dev</p>
                </div>
              </div>
          ...
          <div>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full bg-blue-600 hover:bg-blue-700 text-white px-8 py-4 rounded-xl font-semibold text-lg transition-all duration-300 hover:scale-105 shadow-lg hover:shadow-xl flex items-center justify-center"
              >
                Send Message
