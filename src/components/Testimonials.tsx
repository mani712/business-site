...
const Testimonials = () => {
  ...
  return (
    <section className="py-20 bg-gray-800 transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {testimonials.map((testimonial, index) => (
            <div
              key={index}
              className="bg-gray-700 rounded-2xl p-8 shadow-lg hover:shadow-xl shadow-gray-900/20 hover:shadow-gray-900/40 transition-shadow duration-300"
            >
