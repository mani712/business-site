        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <div className="flex flex-wrap gap-4">
              <div className="bg-blue-100 dark:bg-blue-900/50 px-4 py-2 rounded-full text-blue-800 dark:text-blue-300 font-medium">
                React & Next.js
              </div>
              <div className="bg-indigo-100 dark:bg-indigo-900/50 px-4 py-2 rounded-full text-indigo-800 dark:text-indigo-300 font-medium">
                TypeScript
              </div>
              <div className="bg-green-100 dark:bg-green-900/50 px-4 py-2 rounded-full text-green-800 dark:text-green-300 font-medium">
                Node.js
              </div>
              <div className="bg-purple-100 dark:bg-purple-900/50 px-4 py-2 rounded-full text-purple-800 dark:text-purple-300 font-medium">
                Cloud Solutions
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            {values.map((value, index) => (
              <div
                key={index}
                className="bg-white dark:bg-gray-700 p-6 rounded-2xl shadow-lg hover:shadow-xl dark:shadow-gray-900/20 dark:hover:shadow-gray-900/40 transition-shadow duration-300"
              >
